...
def landing_page():
    ...
    # ── Navbar ───────────────────────────────────────────────────────────
        html.Div(className="landing-navbar", children=[
            ...
            html.Div([
           html.A("FOR TEAMS →", href="/for-teams", className="for-teams-gold", style={
                    "color":"#1a1a1a","fontSize":"0.82em","fontWeight":"900",
                    ...
                    "boxShadow":"0 6px 22px rgba(255,215,0,0.4), inset 0 1px 0 rgba(255,255,255,0.4)",
...
# ── WHAT IS BOJKET — click to reveal ──────────────────────────────────
    ...
    # ── Screenshot Gallery Modal ────────────────────────────────────────
        html.Div(id="gallery-modal", style={"display":"none","position":"fixed","top":"0","left":"0",
                                             "width":"100vw","height":"100vh","backgroundColor":"rgba(0,0,0,0.95)",
                                             "zIndex":"500","backdropFilter":"blur(12px)","overflowY":"auto"}, children=[
            html.Button("✕", id="gallery-close-btn", n_clicks=0, style={
                "position":"fixed","top":"24px","right":"32px","background":"transparent",
                "border":"none","color":"rgba(255,255,255,0.7)","fontSize":"2em","cursor":"pointer",
                "zIndex":"550",
            }),
            html.Div([
                html.Div("INSIDE THE DASHBOARD", style={
                    "color":PURPLE_LIGHT,"fontSize":"0.78em","fontWeight":"800","letterSpacing":"5px",
                    "textAlign":"center","marginBottom":"14px","paddingTop":"60px",
                }),
                html.Div("A look at what your traders see.", style={
                    "color":"white","fontSize":"2em","fontWeight":"900","letterSpacing":"-1px",
                    "textAlign":"center","marginBottom":"60px",
                }),
                html.Div([
                    *[html.Div([
                        html.Img(src=img_url, id={"type":"gallery-img","index":i}, n_clicks=0, style={
                            "width":"100%","display":"block","borderRadius":"14px",
                            "border":"1px solid rgba(168,85,247,0.2)","cursor":"zoom-in",
                    ...
                    ], className="screenshot-card", style={
                        "padding":"14px","backgroundColor":"rgba(20,17,40,0.4)",
                        "border":"1px solid rgba(168,85,247,0.15)","borderRadius":"18px",
                        "transition":"all 0.35s ease",
                    }) for i, (img_url, label, caption) in enumerate([
                        ("https://i.imgur.com/Bo66qdQ.png", "Main dashboard",
                         "Everything in one view — signal, score, trend, RSI, MACD, and your capybara rank."),
                        ("https://i.imgur.com/FfSlJqb.png", "Choosing the trading style",
                         "Pick how you want Bojket to behave — Scalper, Day, Swing, or Position. The engine adapts."),
                        ("https://i.imgur.com/VRGKguR.png", "Pattern recognition",
                         "Candlestick patterns detected live on the chart, with annotations and tooltips."),
                        ("https://i.imgur.com/fHCHU8w.png", "Pattern intelligence",
                         "Patterns detected, live tips & lessons, and the recent pattern history per asset."),
                        ("https://i.imgur.com/u8wJMUr.png", "AI Lab",
                         "Train ML models per asset. Replay 2 years of real history to validate the strategy."),
                        ("https://i.imgur.com/UL8l8Yp.png", "Bojket AI",
                         "Conversational coach. Ask anything about signals, levels, or trade decisions — answered in plain English."),
                        ("https://i.imgur.com/wGDvays.png", "Set trade details",
                         "After I bought or I sold — position size, take profit, and stop loss locked in."),
                        ("https://i.imgur.com/WaYs9M0.png", "Live signal with TP & SL",
                         "Engine score, calculated take profit and stop loss already filled. Ready to execute."),
                        ("https://i.imgur.com/CaRG04P.png", "Trade journal",
                         "Every trade logged automatically — symbol, signal, entry, TP, SL, result, time."),
                    ])],
                ], style={"display":"grid","gridTemplateColumns":"repeat(auto-fill, minmax(380px, 1fr))",
                          "gap":"28px","maxWidth":"1280px","margin":"0 auto","padding":"0 40px 80px 40px"}),
            ]),
        ]),
        # ── Fullscreen Image Lightbox ───────────────────────────────────────
        html.Div(id="lightbox-modal", style={"display":"none","position":"fixed","top":"0","left":"0",
                                              "width":"100vw","height":"100vh","backgroundColor":"rgba(0,0,0,0.98)",
                                              "zIndex":"700","cursor":"zoom-out"}, children=[
            html.Img(id="lightbox-img", style={
                "maxWidth":"95vw","maxHeight":"95vh","position":"absolute",
                "top":"50%","left":"50%","transform":"translate(-50%,-50%)",
                "boxShadow":"0 30px 100px rgba(0,0,0,0.8)","borderRadius":"12px",
            }),
            html.Button("✕", id="lightbox-close-btn", n_clicks=0, style={
                "position":"fixed","top":"24px","right":"32px","background":"transparent",
                "border":"none","color":"white","fontSize":"2em","cursor":"pointer",
            }),
        ]),
    # ── Tour Modal Overlay ─────────────────────────────────────────────
...
AILAB_PANEL_HIDDEN={"position":"fixed","top":"0","right":"0","width":"min(640px, 100vw)","height":"100vh","backgroundColor":"#06050f","borderLeft":f"1px solid {BORDER}","zIndex":"160","display":"none","boxShadow":"-8px 0 60px rgba(0,0,0,0.8)","overflowY":"auto"}
